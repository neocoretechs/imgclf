...
public class ConvolutionLayer implements PlateLayer {
    ...
    public List<Plate> propagateError(List<Plate> errors, double learningRate) {
        ...
        //    throw new IllegalArgumentException("Bad propagation state. size of errors:"+errors.size()+" previousOutput size:"+previousOutput.size()+" previousInput size:"+previousInput.size());
        //}
