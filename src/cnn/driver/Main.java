...
public final class Main {
	...
	// The provided code uses a 1D vector of input features. You might want to create a 2D version for your Deep ANN
	...
	public static void main(String[] args) throws NumberFormatException, IOException {
		...
		System.out.println("The tuneset contains " + comma(tuneset.getSize()) + " examples.  Took "
				+ convertMillisecondsToTimeSpan(System.currentTimeMillis() - start) + ".");

		start = System.currentTimeMillis();
		loadDataset(testset, testsetDir);
		System.out.println("The testset contains " + comma(testset.getSize()) + " examples.  Took "
				+ convertMillisecondsToTimeSpan(System.currentTimeMillis() - start) + ".");
	...
	private static ConvolutionalNeuralNetwork<?> trainPerceptrons(Vector<Vector<Double>> trainFeatureVectors,
		...
		return null;//testSetErrorsAtBestTune;
	}
